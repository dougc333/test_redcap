...
if ($verified) do { 
    ...
    // Most project actions are only allowed for users with design rights 
        ...
        /** @var array<string,bool> Actions and whethere they are allowed without design rights */
        $actions = array(
        ...
        if ($pid == "SYSTEM") {
            ...
            switch ($action) {
                ...
                case "get-usage-stats":
                    ...
                    break;
                case "keep-alive":
                    $response = MultiLanguage::keepAlive();
                    break;
            }
        }
        else {
            ...
            switch ($action) {
                case "save":
                    ...
                    break;
                case "get-sys-lang":
                    $response = MultiLanguage::getSystemLanguage($data["payload"]);
                    break;
