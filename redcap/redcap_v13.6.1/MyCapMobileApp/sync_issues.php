...
elseif (isset($_POST['action']) && $_POST['action'] == "save")
{
    ...
    $sql = "UPDATE redcap_mycap_syncissues 
            ...
            WHERE project_code = '".$_POST['projectCode']."' 
                AND participant_code = '".$_POST['participantCode']."' 
                AND uuid = '".$_POST['issueId']."'";
    db_query($sql);
    ...
    // Log the event
    Logging::logEvent(implode(";\n", $sql), "redcap_mycap_syncissues", "MANAGE", PROJECT_ID, "project_id = ".PROJECT_ID, "Edit resolution for MyCap app sync issue");
}
