...
$disableLongBtn = (($mycap_enabled_global && $myCapEnabled) || $requestSent) ? "disabled" : "";
...
$appendMyCapNotice = '';
if ($myCapEnabled && $mycap_enabled_global) {
    $appendMyCapNotice = RCView::div(array('style'=>'color:red;margin-top:10px;'), RCView::b($lang['global_03'].$lang['colon'])." ".$lang['setup_197']);
}

print RCView::simpleDialog($lang['create_project_113'].RCView::div(array('style'=>'margin-top:15px;'), "<b>{$lang['create_project_114']}</b>{$lang['create_project_115']} <b>{$lang['create_project_116']}</b>").$appendMyCapNotice, $lang['setup_162'], 'longiDialog');
...
{
	$appendLongitudinalNotice = '';
	if ($repeatforms) {
		$appendLongitudinalNotice = RCView::div(array('class' => 'red mt-3'), RCView::b($lang['global_03'] . $lang['colon']) . " " . $lang['setup_198']);
	}
