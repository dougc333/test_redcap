...
function enablePageJS() {
    ...
    $('#addUserBtn').click(function(){
        ...
        if (!chk_username(document.getElementById('new_username'),((auth_meth == 'ldap' || auth_meth == 'ldap_table' || auth_meth == 'aaf' || auth_meth == 'aaf_table' || auth_meth == 'shibboleth_table' || auth_meth == 'openid_connect_table') ? 1 : 0))) {
            simpleDialog(lang.rights_438+((auth_meth == 'ldap' || auth_meth == 'ldap_table' || auth_meth == 'aaf' || auth_meth == 'aaf_table' || auth_meth == 'shibboleth_table' || auth_meth == 'openid_connect_table') ? ' '+lang.rights_401 : ''),null,null,null,"$('#new_username').trigger('focus')");
            return;
        }
        // Open dialog to add new user with custom rights
    ...
    $('#assignDagRoleBtn').click(function(){
        ...
        if ($('#userClickTooltip').css('display') == 'none') {
            ...
            if (!chk_username(document.getElementById('new_username_assign'),((auth_meth == 'ldap' || auth_meth == 'ldap_table' || auth_meth == 'aaf' || auth_meth == 'aaf_table' || auth_meth == 'shibboleth_table' || auth_meth == 'openid_connect_table') ? 1 : 0))) {
                simpleDialog(lang.rights_438+((auth_meth == 'ldap' || auth_meth == 'ldap_table' || auth_meth == 'aaf' || auth_meth == 'aaf_table' || auth_meth == 'shibboleth_table' || auth_meth == 'openid_connect_table') ? ' '+lang.rights_401 : ''),null,null,null,"$('#new_username_assign').trigger('focus')");
                return;
            }
        } else {
