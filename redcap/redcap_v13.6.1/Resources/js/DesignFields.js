...
function deleteField(this_field,section_header) {
	...
	if (section_header) {
		...
		simpleDialog(delFieldMsg+' "<b>'+this_field+'</b>"'+langQuestionMark,delFieldTitle,null,null,null,window.lang.global_53,"deleteFieldDo('"+this_field+"',"+section_header+");",langOD24);
	}
}
