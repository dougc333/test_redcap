...
class Queue
{
    ...
    public function getListAtPage($page=1, $perPage=50, $query='') {
        ...
        $generator = $this->getList($start, $perPage, $query);
        $response = [
     ...
     * @return \Generator
     */
    public function getList($start=0, $limit=0, $query=null)
    {
    ...
    public function deleteMessage($messageID) {
        $queryString = "DELETE FROM {$this->getTableName()} WHERE `id`=? AND `status`!=?";
