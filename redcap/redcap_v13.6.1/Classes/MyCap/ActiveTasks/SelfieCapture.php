...
class SelfieCapture
{
    ...
    /** @var string */
    public $infoTitle = 'Placeholder Intro Page Title';

    /** @var string */
    public $infoInstructions = 'Placeholder Intro Page Instructions';

    /** @var string */
    public $captureTitle = '';

    /** @var string */
    public $captureInstructions = 'Placeholder Capture Instructions';
