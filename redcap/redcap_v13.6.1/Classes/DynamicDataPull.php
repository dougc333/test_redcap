...
class DynamicDataPull
{
	...
	public function getFhirData($mrn, $mapping_list=[])
	{
		...
		try {
			...
			$fhirClient = FhirClientFacade::getInstance($project_id, $user_id);
			$metadataSource = self::getFhirMetadataSource();
			...
			$fhirClient->fetchData($mrn, $metadataSource, $mapping_list);
		} catch (\Exception $e) {
...
//                            ) .
	...
	public function isEnabledInProject()
	{
		...
		// Return boolean
		return (isset($webservice_enabled) && $webservice_enabled && $webservice_type == 'CUSTOM');
	}
	...
	public function isEnabledInProjectFhir()
	{
		...
		// Return boolean
		return (isset($webservice_enabled) && $webservice_enabled && $webservice_type == 'FHIR');
	}
