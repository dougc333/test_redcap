...
class ODM
{
	...
	public static function getProjectAttrMappings($prependRedcapInTag=true, $creatingProject=false, $includeSurveyQueueCustomText=false, $includeDDPFieldMapping=false, $includeDataMartSettings=false, $includeHideFilledForms = false)
	{
	...
	public static function getProjectAttrGlobalVars($Proj, $includeSurveyQueueCustomText=false, $includeDDPFieldMapping=false, $includeDataMartSettings=false, $includeHideFilledFormsSettings=false)
	{
		// Is DDP mapping set?
		if ($includeDDPFieldMapping) {
		...
		$attr = "";
		$mappings = self::getProjectAttrMappings(true, false, $includeSurveyQueueCustomText, $includeDDPFieldMapping, $includeDataMartSettings, $includeHideFilledFormsSettings);
	...
	public static function getOdmMetadata($Proj, $outputSurveyFields=false, $outputDags=false, $xml_metadata_options="", $exportAllCustomMetadataOptions=false)
	{
		...
		$xml .= "<GlobalVariables>\n"
			 ...
			 . self::getProjectAttrGlobalVars($Proj, (defined("API") || $exportAllCustomMetadataOptions || in_array('sq', $xml_metadata_options)), (defined("API") || $exportAllCustomMetadataOptions || in_array('ddpmapping', $xml_metadata_options)), (defined("API") || $exportAllCustomMetadataOptions || in_array('datamartsettings', $xml_metadata_options)), (defined("API") || $exportAllCustomMetadataOptions || in_array('formconditions', $xml_metadata_options)), (defined("API") || $exportAllCustomMetadataOptions || in_array('mycapdata', $xml_metadata_options)))
             ...
             . (defined("API") || $exportAllCustomMetadataOptions || in_array('mycapdata', $xml_metadata_options) ? self::getOdmMyCapSettings($exportAllCustomMetadataOptions) : "")
	...
	public static function parseOdm($xml, $returnCsvDataOnly=false, $removeDagAssignmentsInData=false, $Proj=null)
	{
		...
		$projectAttrMappings = self::getProjectAttrMappings(true, true, true, false, true, true);
    ...
    public static function getOdmMyCapSettings($exportAllCustomMetadataOptions)
    {
