...
class GlassBreaker implements SplObserver
{
    ...
    public function __construct($userID)
    {
        ...
        $fhirBaseUrl = $config->fhir_endpoint_base_url;
    ...
    {
        $token_manager = new FhirTokenManager($this->userID);
    ...
    public function initialize() {
        $fhirBaseUrl = $this->redcapConfig->fhir_endpoint_base_url;
    ...
    public function getProtectedMrnList($project_id)
    {
        ...
        if($encryptedList) {
            ...
            $list = unserialize(decrypt($encryptedList));
        } else $list = [];
