...
class UserRights
{
	...
	public $page_rights = array(
        ...
        "AlertsController:migrateEmailAlerts"=>"alerts",
	...
	public static function addPrivileges($project_id, $rights)
	{
        ...
        if ($q) Logging::logEvent("","redcap_user_rights","insert",$rights['username'],"user = '".db_escape($rights['username'])."'","Add user");
	...
	public static function updatePrivileges($project_id, $rights)
	{
        ...
        if ($q) Logging::logEvent("","redcap_user_rights","update",$rights['username'],"user = '".db_escape($rights['username'])."'","Edit user");
	...
	public static function getApiUserPrivilegesAttr($returnEmailAndName=false, $project_id=null)
	{
		...
		$attr = array('username', 'expiration', 'group_id'=>'data_access_group', 'design', 'alerts', 'user_rights', 'data_access_groups',
				...
				'data_entry'=>'forms', 'data_export_instruments'=>'forms_export');
        if ($project_id !== null) {
            $Proj = new Project($project_id);
	...
	{
		global $Proj;
		if (!defined("USERID")) return $user_rights;
	...
	public static function renderUserRightsRolesTable()
	{
		...
		$rightsHdrs = array(
			'role_name' => array('hdr' => RCView::span(array('style'=>'font-weight:bold;font-size:13px;'), $lang['rights_148']).RCView::div(array('style'=>'font-size:11px;line-height:1.1;padding-top:5px;color:#888;'), $lang['rights_206']), 'enabled' => true, 'width'=>200, 'align'=>'left'),
			'username' => array('hdr' => RCView::span(array('style'=>'font-weight:bold;font-size:13px;'), $lang['global_11'])." ".$lang['rights_150'].RCView::div(array('style'=>'font-size:11px;line-height:1.1;padding-top:5px;color:#888;'), $lang['rights_174']), 'enabled' => true, 'width'=>270, 'align'=>'left'),
			'expiration' => array('hdr' => RCView::span(array('style'=>'font-weight:bold;font-size:12px;'), $lang['rights_95']).RCView::div(array('style'=>'font-size:11px;line-height:1.1;padding-top:5px;color:#888;'), $lang['rights_209']), 'enabled' => true, 'width'=>80),
			'group_id' => array('hdr' => RCView::span(array('style'=>'font-weight:bold;font-size:12px;'), $lang['global_78']).
				($user_rights['group_id'] != '' ? '' : RCView::div(array('style'=>'line-height:1.1;padding-top:3px;color:#888;'), $lang['rights_210'])),
            ...
            'role_id' => array('hdr' => RCView::span(array('style'=>'font-weight:bold;font-size:13px;'), $lang['rights_403']).RCView::div(array('style'=>'line-height:1.1;padding-top:3px;color:#888;'), $lang['define_events_66']), 'enabled' => true, 'width'=>80, 'align'=>'center', 'sort_type'=>'int'),
            'unique_role_name' => array('hdr' => RCView::span(array('style'=>'font-weight:bold;font-size:13px;'), $lang['rights_404']).RCView::div(array('style'=>'line-height:1.1;padding-top:3px;color:#888;'), $lang['define_events_66']), 'enabled' => true, 'width'=>95, 'align'=>'center')
		);
    ...
    public static function uploadUsers($project_id, $data)
    {
        ...
        foreach ($data as $key=>&$this_user) {
            ...
            if (!preg_match("/^([a-zA-Z0-9'_\s\.\-\@])+$/", $this_user['username'])) {
                $errors[] = "username \"".RCView::escape($this_user['username'], false)."\" " . $lang['api_151'] . " " . $lang['rights_438'];
            }
            if ($user_rights['group_id']??"" != "") {
            ...
            foreach ($rights_fields as $field) {
                if (isset($this_user[$field]) && !empty($this_user[$field])) {
                    $validValues = ($field == 'lock_records') ? [0,1,2] : [0,1];
...
//        print "     SQL: ".htmlentities($sql, ENT_QUOTES);
    ...
    public static function uploadUserRoles($project_id, $data) {
        ...
        $rights_fields = array('design','user_rights','data_access_groups','reports','stats_and_charts',
            'manage_survey_participants', 'calendar','data_import_tool','data_comparison_tool','logging',
            'file_repository','data_quality_create','data_quality_execute','api_export','api_import','mobile_app',
    ...
    public static function getApiUserRolesAttr($returnAllAttr = false, $project_id=null)
    {
        ...
        $attr = array('design', 'user_rights', 'data_access_groups',
            'reports', 'graphical' => 'stats_and_charts',
            'participants' => 'manage_survey_participants', 'calendar',
            'data_import_tool', 'data_comparison_tool', 'data_logging' => 'logging',
            'file_repository', 'data_quality_design' => 'data_quality_create', 'data_quality_execute',
