...
//            }
	...
	public function checkAlertsWithDatediffViaCron()
	{
	    ...
	    return $this->checkAlertsBulk(array_keys($this->datediff_cron_queued_records), true);
	}
    ...
    public function checkAlertsBulk($project_ids=null, $datediffsOnly=false, $alert_ids=array())
    {
		// Datediff cron: Return 0's if there are no projects/records to process
		if ($datediffsOnly && empty($this->datediff_cron_queued_records)) {
            return array(0, 0, 0);
		}
									...
									<table class="code_modal_table" id="code_modal_table_update">
										...
										<tr class="form-control-custom" field="alert-condition">
											<td colspan="2" class="external-modules-input-td pb-0 ps-3">
												...
												<textarea type="text" id="alert-condition" name="alert-condition" onfocus="openLogicEditor($(this))" class="external-modules-input-element ms-4" style="max-width:95%;" onkeydown="logicSuggestSearchTip(this, event);" onblur="validate_logic($(this).val());"></textarea>
												<div class="clearfix">
												...
												<div class="ms-2 mt-2">
													...
													<label for="alert-send-how-many3" class="m-0 align-middle">
														...
														<div style="margin-top:0.15rem;">
															...
															<input type="text" name="cron-repeat-for" onblur="if (redcap_validate(this,'0','9999','soft_typed','integer',1) && !isNumeric($(this).val())) $(this).val('0');" class="ps-1 pe-2 py-0 ms-1 text-end external-modules-input-element d-inline" maxlength="4" style="height:24px;width:42px;position:relative;top:2px;">
														...
														<div style="margin-top:0.2rem;">
															...
															<?=$lang['alerts_233']?> <i class="ms-1 text-secondary"><?=$lang['alerts_234']?></i>
														</div>
													</label>
												</div>
...
//                    )
    ...
    public function migrateEmailAlertsNotice()
    {
        ...
        $(function(){
            if ($('#customizedAlertsPreview tr:visible').length >= 1) {
                $('.page_title').append('<div class="float-end ms-3 me-5"><button class="btn btn-xs btn-rcgreen fs13 px-2 py-1" onclick="migrateAlertsDialog();return false;">'
    ...
    public function migrateEmailAlerts()
    {
        ...
        if (empty($errors)) {
            ...
            $q = db_query($sql);
            $logText = "Disable external module \"{$moduleDirectoryPrefix}\" for project";
    ...
    public function displayAlertCheckboxList($project_id)
    {
        ...
        return RCView::p(array('class'=>'mt-0'), $lang['alerts_258']) .
                        ...
                        RCView::div(array('class'=>'gray mb-0'),
                            ...
                            RCView::a(array('class'=>'ms-5 fs11', 'onclick'=>"$('#reeval_alert_dlg input[type=checkbox]').prop('checked',true);", 'style'=>'text-decoration:underline'), $lang['survey_41']) .
                            RCView::a(array('class'=>'ms-2 fs11', 'onclick'=>"$('#reeval_alert_dlg input[type=checkbox]').prop('checked',false);", 'style'=>'text-decoration:underline'), $lang['survey_42']) .
                            $html
                        );
    }
    // Move an alert
