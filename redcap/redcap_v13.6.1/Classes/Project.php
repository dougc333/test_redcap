	...
	public static function apiCreate($userid, $data, $odm=null)
	{
		...
		$sql = "
			INSERT INTO redcap_projects (
				...
				surveys_enabled, auto_inc_set, randomization, data_resolution_enabled, project_note, log_event_table
			) VALUES (
				'$project_name', 0, $longitudinal, $purpose, $purpose_other, '$app_title', '$now', '$created_by',
				$surveys_enabled, $record_autonumbering_enabled, 0, $data_resolution_enabled, $project_note, '$log_event_table'
			)
		";
