...
use Vanderbilt\REDCap\Classes\Fhir\FhirMetadata\Decorators\FhirMetadataDiagnosisDecorator;
...
class DataMart
{
    ...
    public function runRevision($revision_id, $mrn=null)
    {
        ...
        try {
            ...
            if($mrn) {
                ...
                $fhirClient = FhirClientFacade::getInstance($project_id, $this->userid);
                ...
                $fhirClient->fetchData($mrn, $fhirMetadataSource, $mapping_list);
    ...
    public function getFhirMetadataSource()
    {
        ...
        $metadataSource = new FhirMetadataDiagnosisDecorator($metadataSource);
