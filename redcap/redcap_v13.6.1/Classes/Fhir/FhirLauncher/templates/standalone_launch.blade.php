...
@section('content')
    ...
    <div>
        ...
        {{-- <figure class="my-2">
        {!! file_get_contents( $TEMPLATES_DIR. '/assets/standalone-launch-diagram.svg' ) !!}
        <figcaption class="text-muted small">Standalone Launch Flow (more on the <a href="http://hl7.org/fhir/smart-app-launch/app-launch.html" target="_blank">HL7 website</a>)</figcaption>
        </figure> --}}
        <a class="btn btn-primary btn-sm text-white" href="{{$standaloneLaunchURL}}" ><i class="fas fa-rocket"></i> standalone launch</a>
