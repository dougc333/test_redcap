...
trait CanGetAuthorizationToken
{
	 ...
	 * @return void
	 */
	public function getIdentityProvider($fhir_endpoint_base_url, $fhir_identity_provider=null, $iss=null) {
		if($fhir_identity_provider) return $fhir_identity_provider;
		if($iss) return $iss;
		if($fhir_endpoint_base_url) return $fhir_endpoint_base_url;
	}
