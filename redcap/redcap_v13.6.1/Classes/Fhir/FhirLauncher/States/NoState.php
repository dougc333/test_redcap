...
class NoState extends State
{
	...
	public function makeState() {
		...
		$_GET[FhirLauncher::FLAG_SESSION_CREATE_COUNTER] = $sessionInstance = intval(@$_GET[FhirLauncher::FLAG_SESSION_CREATE_COUNTER])+1;
	...
	public function createSession() {
		...
		if($user = @$_SESSION['username']) $session->user = $user;
		return $session;
	}
}