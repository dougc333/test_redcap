...
class RequestAccessTokenState extends State
{
	...
	public function run() {
		...
		$session->accessToken = $accessTokenDTO = $this->getAccessToken($code);
	...
	public function getAccessToken($code) {
		...
		$clientID = $config->fhir_client_id;
		$clientSecret = $config->fhir_client_secret;
		
		$URL = $this->context->getTokenURL();
