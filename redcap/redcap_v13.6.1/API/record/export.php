...
function getRecordsFlat()
{
	...
	return Records::getData($post['projectid'], $post['format'], $records, $fields, $events, $post['dataAccessGroupId'], false,
							...
							(isset($post['exportBlankForGrayFormStatus']) && ($post['exportBlankForGrayFormStatus'] === true || (string)$post['exportBlankForGrayFormStatus'] === '1' || strtolower((string)$post['exportBlankForGrayFormStatus']) === 'true')));
}
