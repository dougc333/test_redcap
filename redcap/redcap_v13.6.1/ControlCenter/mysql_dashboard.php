...
if (isset($read_replica_hostname) && $read_replica_hostname != '' && !isset($GLOBALS['rc_replica_connection']) && isset($_GET['db_server']) && $_GET['db_server'] == 'replica') {
...
if (isset($read_replica_hostname) && $read_replica_hostname != '' && isset($read_replica_username) && isset($read_replica_password) && isset($read_replica_db))
{
    ...
    if (isset($_GET['db_server']) && $_GET['db_server'] == 'replica') {
        ...
        if ($replicaLagTime !== false) {
            $replicaLagText = RCView::span(['class'=>'boldish ml-5', 'style'=>'font-family:arial;'], $lang['check_182']) . " " .$replicaLagTime;
        }
    }
}
...
echo '<tr style="font-weight: bold;">
		<td valign="top" style="border-bottom:1px solid #ccc;background-color:#e5e5e5;padding:5px 10px;">
			<div style="float:left;margin-top:5px;margin-left:5px;">
				...
				<button id="mysql_dash_reload_btn" onclick="reload_mysql_dashboard();" style="margin:0 10px 0 70px;color:#555;">
