...
ExternalModules = $.extend(ExternalModules, {
	...
	sortModuleTable: function(){
		var table = ExternalModules.getEnabledModulesTable()
...
ExternalModules.Settings.prototype.initializeRichTextFields = function(){
	$("#external-modules-configure-modal .external-modules-autocomplete-dropdown").select2({
